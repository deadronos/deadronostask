...
export function TaskList({
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-4 rounded-2xl border border-border bg-white/70 p-6 shadow-sm dark:bg-slate-950/60 md:flex-row md:items-center md:justify-between">
        <div>
