  ...
  return (
    <div className="space-y-6">
      <div className="rounded-2xl border border-border bg-white/70 p-6 shadow-xs dark:bg-slate-950/60">
        ...
        <p className="text-sm text-muted-foreground">Customize your workspace vibe and defaults.</p>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <div className="rounded-2xl border border-border bg-white/70 p-6 shadow-xs dark:bg-slate-950/60">
          ...
          <p className="text-sm text-muted-foreground">Choose where you land after signing in.</p>
          <div className="mt-4">
            <select
